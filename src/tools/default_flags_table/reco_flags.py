...
eicrecon_reco_flags = [
    ...
    ('BEMC:EcalBarrelImagingProtoClusters::localDistXY',        '2.0*mm,2.0*mm',                   ''),
    ...
    ('BEMC:EcalBarrelScFiProtoClusters:localDistXZ',            '30.0*mm,30.0*mm',                 ''),
...
# EEMC - Endcap EMC
    ...
    ('EEMC:EcalEndcapPIslandProtoClusters:localDistXY',          '10*mm,10*mm',                    ''),
    ...
    ('EEMC:EcalEndcapPInsertIslandProtoClusters:localDistXY',          '10*mm,10*mm',                    ''),
    ...
    ('HCAL:HcalBarrelIslandProtoClusters:localDistXY',           '150*mm,150*mm',                  ''),
    ...
    ('HCAL:HcalEndcapNIslandProtoClusters:localDistXY',          '150*mm,150*mm',                  ''),
    ...
    ('HCAL:HcalEndcapPIslandProtoClusters:localDistXY',          '150*mm,150*mm',                  ''),
    ...
    ('ZDC:ZDCEcalIslandProtoClusters:localDistXY',               '50*mm,50*mm',                    ''),
